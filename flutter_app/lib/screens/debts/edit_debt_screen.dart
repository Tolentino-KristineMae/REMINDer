...
class _EditDebtScreenState extends State<EditDebtScreen> {
  ...
  void didChangeDependencies() {
    ...
    if (_debt == null) {
      ...
      if (_debt != null) {
        _descriptionController.text = _debt!['description'] ?? '';
        _amountController.text = _debt!['amount']?.toString() ?? '';
        _personController.text = _debt!['person'] ?? '';
        _type = _debt!['type'] ?? 'owed';
        if (_debt!['due_date'] != null) {
          _dueDate = DateTime.parse(_debt!['due_date']);
        }
      }
    }
  }
  ...
  Future<void> _submitForm() async {
    ...
    try {
      await ApiService.updateDebt(_debt!['id'], {
