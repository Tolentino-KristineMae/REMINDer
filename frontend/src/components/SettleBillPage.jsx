...
const SettleBillPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        console.log('FormData voice_record:', formData.get('voice_record'));
        ...
        try {
            ...
            const errorMessage = proofErr || detailsErr || voiceErr || genericMsg || 'Failed to upload proof. Please try again.';
