                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                    <div className="bg-white rounded-2xl border border-green-100 p-5 shadow-sm">
                        <div className="flex items-start justify-between">
                            <div>
                                <p className="text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-1">Total Settled</p>
                                <p className="text-2xl font-black text-gray-900 tracking-tight">{formatCurrency(totalSettled)}</p>
                            </div>
                        ...
                        <div className="flex items-center gap-1.5 mt-3">
                            ...
                            <span className="text-xs font-bold text-green-600">{settledBills.length} transactions</span>
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-2xl border border-red-100 p-5 shadow-sm">
                        <div className="flex items-start justify-between">
                            <div>
                                <p className="text-[10px] font-bold text-red-400 uppercase tracking-wider mb-1">Awaiting Proof</p>
                                <p className="text-2xl font-black text-gray-900 tracking-tight">{formatCurrency(totalPending)}</p>
                            </div>
                        ...
                        <div className="flex items-center gap-1.5 mt-3">
                            ...
                            <span className="text-xs font-bold text-red-600">{pendingBills.length} pending</span>
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-2xl border border-green-100 p-5 shadow-sm">
                        <div className="flex items-start justify-between">
                            <div>
                                <p className="text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-1">Settlement Rate</p>
                                <p className="text-2xl font-black text-gray-900 tracking-tight">
                                    {bills.length > 0 ? Math.round((settledBills.length / bills.length) * 100) : 0}%
                                </p>
                            </div>
                            <div className="w-10 h-10 rounded-xl bg-green-50 flex items-center justify-center">
                        ...
                        <div className="w-full h-2 bg-gray-100 rounded-full mt-3 overflow-hidden">
                            <div 
                                ...
                                style={{ width: `${bills.length > 0 ? (settledBills.length / bills.length) * 100 : 0}%` }}
                            />
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-2xl border border-gray-100 p-5 shadow-sm">
                        <div className="flex items-start justify-between">
                            <div>
                                <p className="text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-1">Total Bills</p>
                                <p className="text-2xl font-black text-gray-900 tracking-tight">{bills.length}</p>
                            </div>
                            <div className="w-10 h-10 rounded-xl bg-gray-50 flex items-center justify-center">
                                <Receipt className="w-5 h-5 text-gray-500" />
                            </div>
                        </div>
                        <p className="text-xs text-gray-400 mt-3">All time records</p>
                    </div>
                </div>
