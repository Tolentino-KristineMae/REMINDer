        ...
        <>
            <style>{`
                ...
                *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
                ...
                .b2 { width:170px; height:170px; bottom:8%; left:10%; opacity:.06; border-radius:40% 60% 45% 55%/55% 45% 60% 40%; animation:fB 9s ease-in-out infinite; background:linear-gradient(135deg,#22c55e,#86efac); }
                .b3 { width:300px; height:190px; top:12%; right:2%; opacity:.07; border-radius:55% 45% 60% 40%/40% 60% 40% 60%; animation:fC 8s ease-in-out infinite; background:linear-gradient(135deg,#4ade80,#16a34a); }
                .b4 { width:140px; height:140px; bottom:18%; right:6%; opacity:.05; border-radius:50% 50% 40% 60%/60% 40% 60% 40%; animation:fA 6s ease-in-out infinite reverse; background:linear-gradient(135deg,#86efac,#22c55e); }
                .b5 { width:110px; height:110px; top:42%; left:1%; opacity:.04; border-radius:60% 40% 50% 50%/50% 50% 60% 40%; animation:fB 10s ease-in-out infinite; background:linear-gradient(135deg,#bbf7d0,#4ade80); }
                ...
                .dot { position:absolute; border-radius:50%; background:rgba(34,197,94,.2); pointer-events:none; z-index:1; }
